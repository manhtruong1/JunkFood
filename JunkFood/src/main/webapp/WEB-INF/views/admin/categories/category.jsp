			...
			<aside id="layout-menu"
                ...
                <g id="g-app-brand" stroke="none" stroke-width="1"
                  ...
                  <g id="Brand-Logo"
					...
					</span> <span class="app-brand-text menu-text fs-3 ms-2">Store Duy
							Đức</span>
							...
							<div class="col-12">
								...
								<div class="modal fade" id="exampleModalProduct" tabindex="-1"
									...
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<form:form action="/junkfood/category/create" method="post"
								...
								<div class="card mt-4">
									<div class="card-header">
										<h5 class="float-start mt-2">Quản Lý Thể Loại</h5>
										<nav class="navbar bg-light float-end"></nav>
									</div>
													...
													<tr>
														...
														<td>
															...
															<button type="button" class="btn btn-warning"
																...
																data-bs-target="#editModal_${category.categoryid}">
																Edit</button> <!-- Modal -->
															<div class="modal fade"
																id="editModal_${category.categoryid}" tabindex="-1"
																aria-labelledby="exampleModalLabel" aria-hidden="true">
																<div class="modal-dialog modal-lg">
																	<div class="modal-content">
																		...
																		<form:form
																			action="/junkfood/category/update?categoryid=${category.categoryid}"
														...
														<td>
															...
															<button type="button" class="btn btn-danger"
																data-bs-toggle="modal"
																data-bs-target="#deleteModal_${category.categoryid}">
																Delete</button> <!-- Modal -->
															<div class="modal fade"
																id="deleteModal_${category.categoryid}" tabindex="-1"
																aria-labelledby="exampleModalLabel" aria-hidden="true">
																<div class="modal-dialog">
																	<div class="modal-content">
																		...
																		<div class="modal-body">
																			<p class="text-dark">
																				Tên Sản Phẩm: <b>${category.name}</b>

																			</p>
																		</div>
																		<div class="modal-footer">
																			<a href="/junkfood/category/delete/${category.categoryid}"
