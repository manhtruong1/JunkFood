					...
					<div class="container">
						<div class="row mt-5 mb-5">
							<div class="col-12">
											...
											<div class="modal-body">
												<div class="card-body">
													<form action="">
														<div class="row">
															<div class="col-5">
																<img src="images/duc.jpg" width="90%" alt="">
															</div>
															<div class="col-7">
																...
																<div class="form-group mt-3">
																	<label for="">VIEW COUNT</label> <input type="number"
																		class="form-control mt-2" name="" id=""
																...
																<div class="form-check form-check-inline mt-2 p-0 ">
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox"
																			id="active" name="stutus" value="true"> <label
																			class="form-check-label" for="active">Active</label>
																	</div>
																	<div class="form-check form-check-inline">
																		<input class="form-check-input" type="checkbox"
																			id="inactive" name="stutus" value="true"> <label
																			class="form-check-label" for="inactive">In-Active</label>
																	</div>
																</div>
															</div>
														</div>
														...
														<div class="form-group mt-3">
															...
															<textarea name="" id="" cols="50" class="mt-2" rows="4"></textarea>
														</div>
													</form>
												</div>
											</div>
								...
								<div class="card mt-4">
									<h5 class="card-header">Quản lý Order</h5>
											...
											<tbody class="table-border-bottom-0">
												<c:forEach var="order" items="${lOrder}">
													<tr>
														...
														<td>${order.customer.diachi}</td>
														<td>${order.customer.phone}</td>
														<td>
														<fmt:formatNumber
											value="${order.amount}" pattern="#,###"></fmt:formatNumber>
														</td>
														<%-- <td>${order.status == true ? 'Đã Duyệt':'Chờ Duyệt'}</td> --%>
														<td><a href="" class="btn btn-warning text-white">Xác Nhận</a>
														</td>
														<td><a href="" class="btn btn-danger text-white">Hủy Đơn</a>
														</td>
													</tr>
												</c:forEach>
											</tbody>
